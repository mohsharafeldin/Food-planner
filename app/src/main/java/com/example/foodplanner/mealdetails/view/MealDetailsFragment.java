...
public class MealDetailsFragment extends Fragment implements MealDetailsView {
    ...
    private final ActivityResultLauncher<String> requestPermissionLauncher = registerForActivityResult(
            new ActivityResultContracts.RequestPermission(), isGranted -> {
                if (isGranted) {
                    ...
                    // Fallback to Intent if permission denied or manually show toast
                    Toast.makeText(requireContext(), "Permission denied. Using Calendar App instead.",
    ...
    private void initPresenter() {
        ...
        presenter = new MealDetailsPresenter(repository, userId);
    ...
    private void showCalendarDialogInternal(boolean forceIntent) {
        ...
        new DatePickerDialog(requireContext(), (view, year, month, dayOfMonth) -> {
            ...
            if (forceIntent) {
                com.example.foodplanner.utils.CalendarHelper.addMealToCalendar(requireContext(), title, description,
                        time);
            } else {
                com.example.foodplanner.utils.CalendarHelper.addEventToCalendarProvider(requireContext(), title,
                        description, time);
            }
                ...
                if (btnWatchOnYouTube != null) {
                    ...
                    btnWatchOnYouTube.setOnClickListener(v -> {
                        ...
                        try {
                            ...
                            Toast.makeText(requireContext(), "No app found to play video", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
