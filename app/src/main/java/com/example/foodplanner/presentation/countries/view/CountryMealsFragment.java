...
public class CountryMealsFragment extends Fragment
        implements CountryMealsView, MealAdapter.OnMealClickListener {
    ...
    private CountryMealsPresenterContract presenter;
    ...
    private void setupPresenter() {
        presenter = new CountryMealsPresenterImpl(MealRepository.getInstance(requireContext()));
        presenter.attachView(this);
    }

    // ============ CountryMealsView Implementation ============
