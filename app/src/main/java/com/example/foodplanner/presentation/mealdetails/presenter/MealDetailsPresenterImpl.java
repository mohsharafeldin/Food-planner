...
public class MealDetailsPresenterImpl extends BasePresenter<MealDetailsView> implements MealDetailsPresenterContract {

    private final MealRepository repository;
    private Meal currentMeal;
    private final String userId;

    public MealDetailsPresenterImpl(MealRepository repository, String userId) {
