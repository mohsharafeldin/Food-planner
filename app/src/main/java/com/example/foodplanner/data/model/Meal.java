...
public class Meal {
    ...
    // Ingredient getters and setters
    ...
    @Ignore
    public List<IngredientWithMeasure> getIngredientsList() {
    ...
    private void addIngredient(List<IngredientWithMeasure> list, String ingredient, String measure) {
        if (ingredient != null && !ingredient.trim().isEmpty()) {
            list.add(new IngredientWithMeasure(ingredient, measure));
        }
    }
